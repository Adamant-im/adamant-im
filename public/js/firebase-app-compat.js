!(function (e, t) {
  ...
  const r = function (t) {
      ...
      for (let a = 0; a < t.length; a++) {
        ...
        e < 128
          ...
          : (e < 2048
              ? (r[n++] = (e >> 6) | 192)
              : (55296 == (64512 & e) && a + 1 < t.length && 56320 == (64512 & t.charCodeAt(a + 1))
    ...
    n = {
      ...
      decodeStringToByteArray(e, t) {
        ...
        for (let c = 0; c < e.length; ) {
          ...
          ;(n.push((a << 2) | (i >> 4)),
            64 !== s &&
              (n.push(((i << 4) & 240) | (s >> 2)), 64 !== o && n.push(((s << 6) & 192) | o)))
        }
        return n
      },
      init_() {
    ...
    wrapCallback(r) {
      return (e, t) => {
        ;(e ? this.reject(e) : this.resolve(t),
          'function' == typeof r && (this.promise.catch(() => {}), 1 === r.length ? r(e) : r(e, t)))
      }
    }
  }
  ...
  class y {
    ...
    get(e) {
      ...
      if (!this.instancesDeferred.has(t)) {
        const n = new s()
        if (
          (this.instancesDeferred.set(t, n), this.isInitialized(t) || this.shouldAutoInitialize())
        )
          try {
    ...
    return 'function' == typeof e
      ...
      : (e instanceof IDBTransaction &&
          ...
          k.has(i) ||
            ...
            k.set(i, t))),
        T(e, (P = P || [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]))
          ? new Proxy(e, H)
          : e)
    var i, t
  }
  ...
  function le(e, t = {}) {
    ...
    const a = n.name
    if ('string' != typeof a || !a) throw oe.create('bad-app-name', { appName: String(a) })
  ...
  function pe(e, t, r) {
    ...
    if (a || i) {
      ...
      return (
        a && s.push(`library name "${n}" contains illegal characters (whitespace or "/")`),
        a && i && s.push('and'),
        i && s.push(`version name "${t}" contains illegal characters (whitespace or "/")`),
        void q.warn(s.join(' '))
      )
    }
            ...
            null === i
              ...
              : (e, t, ...r) => {
                  ...
                  t >= (null !== a && void 0 !== a ? a : e.logLevel) &&
                    i({ level: C[t].toLowerCase(), message: n, args: r, type: e.name })
                }))
      }
    })(e, t)
  }
  ...
  function _e() {
    return (
      (ve =
        ve ||
        (function (e, t, { blocked: r, upgrade: n, blocking: a, terminated: i }) {
  ...
  async function Ee(e, t) {
    try {
      ...
      e instanceof o
        ? q.warn(e.message)
        : ((r = oe.create('idb-set', { originalErrorMessage: null == e ? void 0 : e.message })),
          q.warn(r.message))
    }
  }
  function ye(e) {
      ...
      var e = Ie(),
        { heartbeatsToSend: t, unsentEntries: r } = (function (e, t = 1024) {
          ...
          for (const a of e) {
            ...
            } else if ((r.push({ agent: a.agent, dates: [a.date] }), De(r) > t)) {
              r.pop()
              break
            }
            n = n.slice(1)
      ...
      if (await this._canUseIndexedDBPromise) {
        ...
        return Ee(this.app, {
          lastSentHeartbeatDate:
            null !== (t = e.lastSentHeartbeatDate) && void 0 !== t ? t : r.lastSentHeartbeatDate,
  ...
  class Oe {
    ...
    _getService(e, t = Q) {
      ...
      return (
        n.isInitialized() ||
          'EXPLICIT' !==
            (null === (r = n.getComponent()) || void 0 === r ? void 0 : r.instantiationMode) ||
          n.initialize(),
