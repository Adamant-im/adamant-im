    ...
    blocks.forEach(block => {
      if (block.type === 'paragraph') {
        ...
        let value = block.value
          ...
          .replace(inline.bold, (match, space, p1) => space + this.renderer.bold(p1))
          .replace(inline.italic, (match, space, p1) => space + this.renderer.italic(p1))
          .replace(inline.strike, (match, space, p1) => space + this.renderer.strike(p1))
          .replace(inline.code, (match, space, p1) => space + this.renderer.code(p1))
