...
describe('QR and loading UI contract', () => {
  it('defines shared qr and loading tokens in the generic token layer', () => {
    ...
    expect(content).toContain('--a-color-surface-camera')
  ...
  it('keeps qr renderer and scanner layout tokenized', () => {
    ...
    expect(scannerContent).toContain('`${classes.root}__status-title`')
    expect(scannerContent).toContain('`${classes.root}__state-title')
    expect(scannerContent).toContain('`${classes.root}__state-message')
    expect(scannerContent).toContain('@include mixins.a-text-header();')
    expect(scannerContent).toContain('@include mixins.a-text-regular();')
    ...
    expect(scannerContent).toContain('background-color: var(--a-color-surface-camera);')
    ...
    expect(scannerContent).not.toContain('background-color: #000;')
