...
describe('Login UI style contract', () => {
  ...
  it('uses tokenized passphrase field paddings in login form', () => {
    ...
    expect(content).toContain('&__username-input')
  ...
  it('uses semantic auth classes and tokenized spacing around create-new and password hint blocks', () => {
    ...
    expect(passphraseContent).not.toContain(
      'class="a-btn-link passphrase-generator__create-button"'
    )
  ...
  it('defines stronger hover/focus feedback for link-like action buttons globally', () => {
    ...
    expect(content).toContain('var(--a-link-action-font-size)')
    expect(content).toContain('var(--a-link-action-font-weight)')
    expect(content).toContain('var(--a-link-action-overlay-opacity-light)')
    expect(content).toContain('var(--a-link-action-overlay-opacity-dark)')
    ...
    expect(content).toContain('opacity: var(--a-link-action-overlay-opacity-light);')
    expect(content).toContain('opacity: var(--a-link-action-overlay-opacity-dark);')
