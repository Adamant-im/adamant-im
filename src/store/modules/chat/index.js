...
const state = () => ({
  ...
  // isFulfilled does not indicate that chats stored locally
  // isFulfilled indicates that retrieving is in progress only
  isFulfilled: true // false - getChats in progress, true - getChats did not start or finished
})
